...
class DetalhesSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            ...
            'nacionalidade', 'residencia_estado', 'residencia_cidade', 
            'residencia_endereco', 'residencia_cep', 'classe_profissional', 
            'profissao', 'valor_patrimonio', 'pep', 'fatca', 
            'telefones_adicionais', 'telefone_comercial', 
